...
public class ContraseniaTest {
  ...
  public void unaContraseniaEsDemasiadoComun(){
    Throwable exception = assertThrows(ContraseniaInvalidaException.class,() -> new Duenio("PepeOscar",  "password", callejeritos,"Pepe","Chavez", LocalDate.now(),"DNI",19875698, pepeContacto));
  ...
  public void unaContraseniaEsDemasiadoCorta(){
    Throwable exception = assertThrows(ContraseniaInvalidaException.class,() -> new Duenio("Pablo","1", callejeritos, "Pablo", "Fernandez", LocalDate.now(),
  ...
  public void unaContraseniaContieneAlUsuario(){
    Throwable exception = assertThrows(ContraseniaInvalidaException.class, () -> new Duenio("Mezar",  "Mezar1234567", callejeritos,"Pepe","Chavez", LocalDate.now(),"DNI",19875698, pepeContacto));
